...
Diese Anforderungen sind Teil der Definition of Done von MS-5 und werden nicht auf einen späteren Meilenstein verschoben:

| ID | Gilt auch in MS-5 |
| --- | --- |
...
**Umfang:** Koralle anlegen mit Bezeichnung und Pflicht-Beckenauswahl (FR-1.2, FR-1.14); einfache Bestandsliste ohne Verlinkung (Detailseite folgt in MS-6).

**Bewusst noch nicht enthalten:** Kachelansicht, Filter, Sortierung, Suche, Bild-Upload. Das folgt in MS-9.

**Definition of Done:** Speichern ohne Becken wird mit einem Feldfehler abgelehnt; angelegte Korallen erscheinen in der Liste. Anklickbar werden die Einträge mit der Detailseite in MS-6.
