...
- [x] **Bestand mit Becken, aber ohne Korallenliste.** Die Korallenliste und „Koralle hinzufügen" kommen erst in MS-5.
      Vorschlag für MS-4: Überschrift „Bestand" und ein neutraler Satz ohne Aktion; MS-5 ersetzt ihn.
      → Entschieden: „Die Korallenliste folgt in Kürze."

## Schritte

1. [x] Platzhalter-Inhalt in `src/pages/HomeScreen.tsx` ersetzen (Abmelden ist nach TASK-04-01 bereits umgezogen).
2. [x] Mit `useTanks()` prüfen, ob Becken existieren:
...
3. [x] Im Bestand erscheint in MS-4 **keine** Aktion „Koralle hinzufügen".

## Fertig, wenn

- [x] Nach einer Registrierung mit neuer E-Mail steht sofort der Hinweis „Lege zuerst ein Becken an" mit Button da
- [x] Der Button führt direkt ins Formular (eine Interaktion, NFR-1.2)
- [x] Nach dem Anlegen des ersten Beckens ist der Hinweis im Bestand verschwunden
- [x] Beim Neuladen blitzt der Leerzustand nicht auf, wenn Becken existieren
- [x] Fehlerzustand ist sichtbar zu machen (Offline)
